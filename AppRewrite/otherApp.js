...
# > 百视TV
# hostname = bp-api.bestv.com.cn, bp-image.bestv.com.cn
# 开屏广告 【Runestoner】分享
...
# > 福享太平
# hostname = ecloud.tppension.cntaiping.com
# 去开屏广告
...
# > 汇付天下
# hostname = mcsp.cloudpnr.com, saas-ad.cloudpnr.com
# 感谢【可莉】分享
...
# > 海马爸比
# hostname = 39.98.135.211
^https?:\/\/39\.98\.135\.211\/admin\/filter\/crowdFunding\/getNewProductData url reject-dict
...
# > 驾校一点通
# hostname = richmanrules.ksedt.com, api.jxedt.com, richmanapi.jxedt.com
# 开屏广告 感谢【jinlvei】分享
...
# > 锦江荟APP
# hostname = booking.bestwehotel.com
...
# > 鲁班到家用户版
# hostname = order-app-api.lbdj.com
# 去开屏广告
...
# > 闪动校园
# hostname = api.huachenjie.com, open.e.kuaishou.cn, ad.shunchangzhixing.com, zlsdk.1rtb.net
# 感谢【𝔐𝔞𝔨𝔞𝔟𝔞 𝔨𝔞】分享
# 去除ai视频
...
# > 下厨房
# hostname = *.pglstatp-toutiao.com, res1.hubcloud.com.cn
# 去开屏
^http?:\/\/.*\.pglstatp-toutiao\.com url reject-200
^http:\/\/res1\.hubcloud\.com\.cn url reject-200

# > 厦门航空
# hostname = mobileapi.xiamenair.com
# 开屏广告
...
# 响应体
^https:\/\/youtubei\.googleapis\.com\/youtubei\/v1\/(browse|next|player|search|reel\/reel_watch_sequence|guide|account\/get_setting|get_watch) url script-response-body https://github.com/Maasea/sgmodule/raw/master/Script/Youtube/dist/youtube.response.preview.js
# 播放页广告
